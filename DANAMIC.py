...
while True:
        ...
        while True:
            if count == 1:
                ...
                try:
                    ...
                    # 7. Single peptide vs All bacteria:
                    ...
                    # 8. Single Bacteria vs All peptides:
                    ...
                    MIC_2.to_excel(writer, sheet_name="Single peptide vs All bacteria")
                    MIC_3.to_excel(writer, sheet_name="Single Bacteria vs All peptides")
                    ...
                    for b in bacteria:
                        ...
                        for p in peptide:
                            ...
                            position = 15 * (count - 1)
                            pep.to_excel(writer, sheet_name="bac_pep_plot", startrow=position)
                            workbook = writer.book
                            worksheet = writer.sheets['bac_pep_plot']
                            chart = workbook.add_chart({'type': 'column'})
                            chart.add_series({
                                'name': ['bac_pep_plot', 1 + position, 1],
                                'categories': ['bac_pep_plot', 1 + position, 2, 9 + position, 2],
                                'values': ['bac_pep_plot', 1 + position, 3, 9 + position, 3],
                                'data_labels': {'value': True},

                                # 'y_error_bars': {'type': 'custom',
                                #                  'plus_values':  ['bac_pep_plot', 1 + position, 4, 9 + position, 4],
                                #                  'plus_data': None,
                                #                  'minus_values': None,
                                #                  'minus-data': None
                                #                 }
    ...
    try:
        ...
        #photo = tk.PhotoImage(file="bacteria_icon_test.png")
